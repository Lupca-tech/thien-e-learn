...
class ChatMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_message" do
    assert_difference('ChatMessage.count') do
      post chat_messages_url, params: { chat_message: { content: @chat_message.content, student_id: @chat_message.student_id, subject_id: @chat_message.subject_id, teacher_id: @chat_message.teacher_id } }
    end
  ...
  test "should update chat_message" do
    patch chat_message_url(@chat_message), params: { chat_message: { content: @chat_message.content, student_id: @chat_message.student_id, subject_id: @chat_message.subject_id, teacher_id: @chat_message.teacher_id } }
