...
class CountdownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create countdown" do
    assert_difference('Countdown.count') do
      post countdowns_url, params: { countdown: { student_id: @countdown.student_id, time: @countdown.time } }
    end
  ...
  test "should update countdown" do
    patch countdown_url(@countdown), params: { countdown: { student_id: @countdown.student_id, time: @countdown.time } }
